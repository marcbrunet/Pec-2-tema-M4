...
funcio dels paquets intalats, comprovem la distribuic en concret\footnote{he echo servir las distribbuciones ubuntu i fedora, deveria funcionar en redhat devenin entre otoros.} i aplicamos el gestor de paquetes en cuention 
\lstinputlisting[basicstyle=\tiny, language=bash, firstline=8, lastline=26]{script.sh}
